...
#u      print('======== LOAD PRETRAINED FACE ID MODEL {} ========='.format(opt_parser.load_a2l_G_name))
        self.G.to(device)
...
#u      print('======== LOAD PRETRAINED FACE ID MODEL {} ========='.format(opt_parser.load_a2l_C_name))
        print('Usami 66666666666666666666')                                          
        self.C.to(device)
...
#u      print('====================================')
        for key in self.test_embs.keys():
            xxx=0
#u          print(key)
#u          PRINTING  RANDOMWORDS ---------------
#u          print(' Usami 77777777777777777777')
#u      print('====================================')
    ...
    #
        ...
        fl_dis_pred = torch.tensor(fl_dis_pred).to(device) * self.opt_parser.amp_pos*1.00 ###<---ここで動きを決める
    ...
    def __train_pass__(self, au_emb=None, centerize_face=False, no_y_rotation=False, vis_fls=False):
        ...
        for i, batch in enumerate(dataloader):
            ...
            for key in keys: # ['45hn7-LXDX8']: #['sxCbrYjBsGA']:#
                ...
                print(' Usami------88888888888888888888------------')
                if(vis_fls):
